...
export const validateCreateExperience = (
  data: unknown
): ValidationResult<CreateExperienceData> => createExperienceSchema.safeParse(data);

export const validateUpdateExperience = (
  data: unknown
): ValidationResult<UpdateExperienceData> => updateExperienceSchema.safeParse(data);

export const validateDeleteExperience = (
  data: unknown
): ValidationResult<DeleteExperienceData> => deleteExperienceSchema.safeParse(data);
